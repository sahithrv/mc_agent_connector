...
const DEFAULT_BLUEPRINTS: BlueprintVariation[] = [
  {
    ...
    requiredMaterials: { cobblestone: 42, oak_planks: 30, glass: 8, torch: 4 },
    schematicData: boxSchematic("cobblestone", "oak_planks", "glass"),
  },
  {
    id: "residential:desert-hut",
    type: "residential",
    displayName: "Desert Hut",
    requiredMaterials: { sandstone: 48, oak_planks: 12, glass: 4, torch: 2 },
    schematicData: boxSchematic("sandstone", "sandstone", "glass"),
  },
  {
    id: "residential:spruce-cabin",
    type: "residential",
    displayName: "Spruce Cabin",
    requiredMaterials: { spruce_log: 36, spruce_planks: 28, glass: 6, torch: 3 },
    schematicData: boxSchematic("spruce_log", "spruce_planks", "glass"),
  },
  {
    id: "blacksmith:stone-forge",
    type: "blacksmith",
    displayName: "Stone Forge",
    requiredMaterials: { cobblestone: 56, furnace: 2, iron_bars: 6, coal: 8 },
    schematicData: boxSchematic("cobblestone", "stone_bricks", "iron_bars"),
  },
  {
    id: "blacksmith:timber-smelter",
    type: "blacksmith",
    displayName: "Timber Smelter",
    requiredMaterials: { stone: 40, oak_log: 18, furnace: 2, coal: 8 },
    schematicData: boxSchematic("stone", "oak_log", "air"),
  },
  {
    id: "farm:basic-wheat",
    type: "farm",
    displayName: "Basic Farm",
    requiredMaterials: { dirt: 36, wheat_seeds: 16, oak_fence: 18, water_bucket: 1 },
    schematicData: farmSchematic("wheat"),
  },
  {
    id: "farm:carrot-strip",
    type: "farm",
    displayName: "Carrot Strip",
    requiredMaterials: { dirt: 30, carrot: 12, spruce_fence: 16, water_bucket: 1 },
    schematicData: farmSchematic("carrots"),
  },
  {
    id: "watchtower:oak-lookout",
    type: "watchtower",
    displayName: "Oak Lookout",
    requiredMaterials: { oak_log: 32, ladder: 8, torch: 6, cobblestone: 18 },
    schematicData: towerSchematic("oak_log", "oak_planks"),
  },
  {
    id: "watchtower:stone-sentry",
    type: "watchtower",
    displayName: "Stone Sentry",
    requiredMaterials: { stone_bricks: 46, ladder: 8, torch: 6, oak_planks: 10 },
    schematicData: towerSchematic("stone_bricks", "oak_planks"),
  },
];
...
function farmSchematic(crop: string): string[][][] {
  return [[
    ["oak_fence", "oak_fence", "oak_fence", "oak_fence"],
    ["oak_fence", crop, "water", "oak_fence"],
    ["oak_fence", crop, crop, "oak_fence"],
    ["oak_fence", "oak_fence", "oak_fence", "oak_fence"],
  ]];
}
